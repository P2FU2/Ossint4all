...
def test_new_connectors_are_wired(settings) -> None:
    ...
    assert {"diario_oficial", "geo_public", "rdap_public", "shodan_public", "host_public", "email_public", "phone_public", "aleph_public", "censys_public", "host_observe", "google_public", "pncp_public", "congresso_public", "politicos_public", "opensanctions_public", "gleif_public"} <= names
    ...
    assert "politicos_public" in enabled
