...
EMBEDDED_TOOLS: tuple[EmbeddedTool, ...] = (
    ...
    EmbeddedTool("plate", "Placa", "Série histórica Mercosul/cinza e portais oficiais. Sem dono no DETRAN.", "PLATE", "ABC1D23", "SENATRAN / DENATRAN"),
    ...
    EmbeddedTool("cnpj", "CNPJ", "Ficha cadastral e QSA oficiais.", "CNPJ", "00.000.000/0001-00", "Minha Receita / BrasilAPI"),
    EmbeddedTool("cpf", "CPF", "Valida o número. A Receita não publica o nome pelo CPF.", "CPF", "000.000.000-00", "Receita Federal"),
    EmbeddedTool("email", "E-mail", "Normaliza e deriva o @user do local. Sem caixa nem vazamento.", "EMAIL", "nome@dominio.com", "user-scanner"),
